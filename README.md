# (Unofficial) eBay API client (PHP) - Sell / Listing
...
```shell
composer require bricre/ebay-api-sell-listing
```
...
Starting from version v1_beta.3.0, this project will match according eBay API's versioning. Should you found a matching 
...
Client::configure(
    new \GuzzleHttp\Client([
        'base_uri' => 'https://api.ebay.com/sell/listing/v1_beta/',
        'headers'=>[
